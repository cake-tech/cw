...
final class Configurations {
    ...
    static let defaultMoneroNode = MoneroNodeDescription(uri: "xmr-node-usa-east.cakewallet.com:18081")
    static let defaultEuMoneroNode = MoneroNodeDescription(uri: "xmr-node-eu.cakewallet.com:18081")
